    ...
    if 'url' in data and data['url']:
        ...
        try:
            ...
            if use_web_search:
                ...
                if model.lower() == 'mistral':
                    formatted_content = generate_content_with_references(article_content, data['url'], complexity, 'mistral')
                else:
                    formatted_content = generate_content_with_references(article_content, data['url'], complexity, 'chatgpt')
            else:
        ...
        try:
            ...
            if use_web_search:
                # Use web search for either model
                if model.lower() == 'mistral':
                    formatted_content = generate_content_with_references(text_content, '', complexity, 'mistral')
                else:
                    formatted_content = generate_content_with_references(text_content, '', complexity, 'chatgpt')
            else:
                # Use standard model without web search
                if model.lower() == 'mistral':
